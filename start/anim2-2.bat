...
SET CLASSPATH=%MASON_HOME%;sugarscape.jar;%JARS%\mason.jar;%JARS%\jfreechart-1.0.1.jar;%JARS%\jcommon-1.0.0.jar;%JARS%\itext-1.4.5.jar;%JARS%\quaqua-colorchooser-only.jar
...
java -Xmx128M sim.app.sugarscape.SugarscapeWithUIHigh -file conf/fig2-2.conf

rem Restoring the classpath.
SET CLASSPATH=%OLDCLASSPATH%

rem code below was taken from fig2-2.sh
rem libjar=lib/jfreechart-1.0.13.jar:lib/jcommon-1.0.16.jar:lib/quaqua-colorchooser-only.jar:lib/itext-2.1.5.jar

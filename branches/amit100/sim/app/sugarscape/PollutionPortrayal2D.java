...
public class PollutionPortrayal2D extends SimplePortrayal2D
    {
    public Paint paint;
    public double scale;
    public static Color brown = new Color(188,130,99);

    public PollutionPortrayal2D() { this(Color.gray,1.0); }
    public PollutionPortrayal2D(Paint paint) { this(paint,1.0); }
    public PollutionPortrayal2D(double scale) { this(Color.gray,scale); }

    public PollutionPortrayal2D(Paint paint, double scale)
        {
        this.paint = paint;
        this.scale = scale;
        }
    ...
    public void draw(Object object, Graphics2D graphics, DrawInfo2D info)
        ...
        float proportion = ((sim.app.sugarscape.Scape)object).getPollutionSize()/4;
        if (proportion < .25) {
            if (proportion > .0001f) {
                proportion = .25f;
            }
